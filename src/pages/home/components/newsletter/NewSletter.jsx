...
export default function NewSletter() {
  return (
    <div className="relative isolate py-16 ">
      <div className="mx-auto max-w-7xl px-6 lg:px-8 overflow-hidde">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <div className="mt-6 flex max-w-md gap-x-4">
              ...
              <input
                ...
                autoComplete="email"
                className="min-w-0 flex-auto rounded-md bg-black/5 px-3.5 py-2 text-base text-black outline outline-1 -outline-offset-1 outline-black/2 placeholder:text-gray-500 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6"
              />
              <button
                type="submit"
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              ...
              <dd className="mt-2 text-base/7 text-black/50">
      ...
      <div
        aria-hidden="true"
        className="absolute top-0 -z-10 -translate-x-1/2 blur-3xl xl:-top-6"
      >
        <div
          style={{
            clipPath:

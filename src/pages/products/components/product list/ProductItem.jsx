      ...
      <div className="flex flex-col p-3 gap-2">
        ...
        <div className="flex flex-col gap-2 pt-1">
          <button
            ...
            className="flex items-center justify-center gap-2 bg-indigo-600  hover:bg-indigo-700  text-white px-4 py-1.5 rounded-md text-sm font-medium transition duration-300"
          >
